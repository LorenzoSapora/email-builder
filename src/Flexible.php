...
use LorenzoSapora\EmailBuilder\Http\ScopedRequest;
use LorenzoSapora\EmailBuilder\Value\Resolver;
use LorenzoSapora\EmailBuilder\Value\ResolverInterface;
use LorenzoSapora\EmailBuilder\Layouts\Preset;
use LorenzoSapora\EmailBuilder\Layouts\Layout;
use LorenzoSapora\EmailBuilder\Layouts\LayoutInterface;
use LorenzoSapora\EmailBuilder\Layouts\Collection as LayoutsCollection;
...
class Flexible extends Field
{
     ...
     * @var string
     */
    public $component = 'email-builder';
