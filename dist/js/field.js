...
Nova.booting(function (Vue, router, store) {
    ...
    Vue.component('detail-email-builder', __webpack_require__(5));
    Vue.component('detail-email-builder-group', __webpack_require__(8));
    Vue.component('form-email-builder', __webpack_require__(11));
    Vue.component('form-email-builder-group', __webpack_require__(17));
    Vue.component('delete-email-builder-group-modal', __webpack_require__(25));
    Vue.component('icon-arrow-down', __webpack_require__(28));
    Vue.component('icon-arrow-up', __webpack_require__(30));
    Vue.component('icon-plus-square', __webpack_require__(32));
    Vue.component('icon-minus-square', __webpack_require__(34));
});
          ...
          _vm.order.length > 0
            ? _c(
                ...
                _vm._l(_vm.orderedGroups, function(group) {
                  return _c("form-email-builder-group", {
                    key: group.key,
                    attrs: {
                      field: _vm.field,
                      group: group,
                  ...
                  ? _c("div", { staticClass: "relative" }, [
                      _vm.isLayoutsDropdownOpen
                        ? _c(
                            ...
                            {
                              staticClass:
                                "absolute rounded-lg shadow-lg max-w-full mt-11 pin-t max-h-search overflow-y-auto border border-40"
                            },
                            [
                              _c(
                                "div",
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        {
          staticClass: "-mb-1 flex flex-col min-h-full",
